...
if(PNG_FOUND)
    list(APPEND SUNSHINE_DEFINITIONS VIBESHINE_STEAM_ARTWORK_HAS_PNG=1)
    list(APPEND SUNSHINE_EXTERNAL_LIBRARIES PNG::PNG)
    list(APPEND STEAM_ARTWORK_TEST_DEFINITIONS VIBESHINE_STEAM_ARTWORK_HAS_PNG=1)
    list(APPEND STEAM_ARTWORK_TEST_LIBRARIES PNG::PNG)
endif()
if(JPEG_FOUND)
    list(APPEND SUNSHINE_DEFINITIONS VIBESHINE_STEAM_ARTWORK_HAS_JPEG=1)
    list(APPEND SUNSHINE_EXTERNAL_LIBRARIES JPEG::JPEG)
    list(APPEND STEAM_ARTWORK_TEST_DEFINITIONS VIBESHINE_STEAM_ARTWORK_HAS_JPEG=1)
    list(APPEND STEAM_ARTWORK_TEST_LIBRARIES JPEG::JPEG)
endif()
if(STEAM_ARTWORK_WEBP_LIBRARY)
    list(APPEND SUNSHINE_DEFINITIONS VIBESHINE_STEAM_ARTWORK_HAS_WEBP=1)
    list(APPEND SUNSHINE_EXTERNAL_LIBRARIES ${STEAM_ARTWORK_WEBP_LIBRARY})
    list(APPEND STEAM_ARTWORK_TEST_DEFINITIONS VIBESHINE_STEAM_ARTWORK_HAS_WEBP=1)
    list(APPEND STEAM_ARTWORK_TEST_LIBRARIES ${STEAM_ARTWORK_WEBP_LIBRARY})
endif()
if(PNG_FOUND AND JPEG_FOUND AND STEAM_ARTWORK_WEBP_LIBRARY)
    ...
    list(APPEND STEAM_ARTWORK_TEST_DEFINITIONS VIBESHINE_STEAM_ARTWORK_IMAGE_LIBS=1)
endif()
